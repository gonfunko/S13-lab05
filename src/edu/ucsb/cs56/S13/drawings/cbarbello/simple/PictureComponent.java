package edu.ucsb.cs56.S13.drawings.cbarbello.simple;
...
/**
   ...
   @author Casey Barbello (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Casey Barbello", 20,40);
    }
