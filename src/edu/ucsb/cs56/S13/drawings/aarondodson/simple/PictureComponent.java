package edu.ucsb.cs56.S13.drawings.aarondodson.simple;
...
/**
   ...
   @author Aaron Dodson (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Aaron Dodson", 20,40);
    }
