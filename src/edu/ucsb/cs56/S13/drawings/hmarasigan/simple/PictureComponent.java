package edu.ucsb.cs56.S13.drawings.hmarasigan.simple;
...
/**
   ...
   @author Hans Marasigan (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Hans Marasigan", 20,40);
    }
