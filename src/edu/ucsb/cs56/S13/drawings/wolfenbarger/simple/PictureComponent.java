package edu.ucsb.cs56.S13.drawings.wolfenbarger.simple;
...
/**
   ...
   @author Martin Wolfenbarger (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Martin Wolfenbarger", 20,40);
    }
