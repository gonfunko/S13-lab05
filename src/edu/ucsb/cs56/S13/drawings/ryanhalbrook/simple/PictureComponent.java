package edu.ucsb.cs56.S13.drawings.ryanhalbrook.simple;
...
/**
   ...
   @author Ryan Halbrook (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      g2.draw(snowManTopCircle);
       ...
       g2.drawString("Top of snowman added by Ryan Halbrook", 20,40);
    }
