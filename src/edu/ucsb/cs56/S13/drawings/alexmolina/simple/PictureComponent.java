package edu.ucsb.cs56.S13.drawings.alexmolina.simple;
...
/**
   ...
   @author Alex Molina (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManTopCircle = 
       ...
       g2.drawString("Top of snowman added by Alex Molina", 20,40);
    }
